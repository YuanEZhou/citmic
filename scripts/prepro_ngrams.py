...
def main(params):
  ...
  if params['flag'] == 'en':
    itow = json.load(open(params['dict_json'], 'r'))['ix_to_word_en']
  elif params['flag'] == 'zh':
    itow = json.load(open(params['dict_json'], 'r'))['ix_to_word_zh']
...
if __name__ == "__main__":
  ...
  parser.add_argument('--dict_json', default='data/cocotalk_mic.json', help='output json file')
  parser.add_argument('--output_pkl', default='data/coco-train-zh', help='output pickle file')
  parser.add_argument('--split', default='train', help='test, val, train, all')
  parser.add_argument('--flag', default='zh', help='en or zh.')
