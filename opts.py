...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--mode', type=str, default='en',
                    help='language mode: en|zh|pair')
    parser.add_argument('--zh_reverse', type=bool, default=False,
                    help='whether reversing zh during pair mode.')
    parser.add_argument('--input_json', type=str, default= 'data/cocotalk_mic.json',
    ...
    parser.add_argument('--input_label_h5', type=str,  default= 'data/cocotalk_mic_label.h5', 
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--cached_tokens', type=str, nargs='+', default=['coco-train-idxs', 'coco-train-zh-idxs'],
                    help='Cached token file for calculating cider score during self critical training.')

    # Model settings
    parser.add_argument('--caption_model', type=str, default='cit',
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer, cbt, cit')
    ...
    parser.add_argument('--seed', type=int, default= 0,
                    help='Random seed.')
    parser.add_argument('--lang_inter_weight', type=float, default= 0,
                    help='Language interactive weight.')
    parser.add_argument('--lang_inter_af', type=str, default= 'relu',
                    help='The activation function of language interaction. relu|tanh...')
